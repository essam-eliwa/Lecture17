...
import 'package:lec16_shop/widgets/products_grid.dart';
import 'package:lec16_shop/widgets/badge.dart';
import 'package:lec16_shop/models/cart.dart';
...
class _ProductsOverviewScreenState extends State<ProductsOverviewScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${widget._userName} Shop'),
        actions: <Widget>[
          PopupMenuButton(
